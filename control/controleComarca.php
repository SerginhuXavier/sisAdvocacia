<?php
require_once"../model/classComarca.php";
...
switch ($opcao){
	...
	case "lista":
		...
		echo "
		<script>window.location='../view/altComarca.php?id=".$id."';</script>";
	break;
	...
	case "excluir":
		...
		$objComarcaDAO->inativar($objComarca);
			echo "
			<script> window.location='../view/consultarComarca.php?pag=processo';</script>";
	break;
}
?>