...
<body>
<center>
<img src="public/img/logoadvocacia.jpg" width='394' height='201' /><br>
  <br>
</center>
...
<td><span id="errorLogin" class="texto"> </span></td>
</tr>
<tr>
<td class="texto">Senha:</td>
<td><input type="password" name="senha" id="senha" class="form"></td>
<td><span id="errorSenha" class="texto"></span></td>
<tr>
<td colspan="2" align="center"><input type="button" value="LOGAR" class="form" id='logar'></td>
</tr>
</table>
</form>
</body>
